...
document.addEventListener("DOMContentLoaded", () => {
   ...
   //modal pop up for creating product
    ...
    async function createProductJSON() {
        ...
        try {
            const response = await authorize(`http://localhost:3000/filter/categoryLargest?category=${selectedProductType}`); //gets the id of the last product in the categoru
